...
use ChatwingFloatUI\Api\Action;
use ChatwingFloatUI\Api\Response;
...
class Api extends Object
{
    ...
    private $apiDomains = array(
        'development' => 'http://staging.chatwing.com/',
    ...
    public function __construct($clientId, $accessToken = '', $apiVersion = 2)
    {
        ...
        $currentEnv = getenv('HTTP_CHATWING_FLOAT_UI_ENV') ? getenv('HTTP_CHATWING_FLOAT_UI_ENV') : CW_ENV_PRODUCTION;
     ...
     * @param array $params
     *
     * @throws Exception\ChatwingFloatUIException
     * @return \ChatwingFloatUI\Api\Response
     */

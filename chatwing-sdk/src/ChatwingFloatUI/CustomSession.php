...
use ChatwingFloatUI\Exception\ChatwingException;
...
class CustomSession extends Object
{
    ...
    protected function getKeyAndIv()
    {
        ...
        if (!$secret) {
            throw new ChatwingFloatUIException(array('message' => __('Secret has not been set !!', CHATWING_FLOAT_UI_TEXTDOMAIN)));
        }
